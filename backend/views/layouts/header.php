...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">Shop</span><span class="logo-lg">' . "My Shop" . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
...
<!--                        <span class="label label-success">4</span>-->
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php if (Yii::$app->user->isGuest){
                          echo  ' <img src="/image/moren.jpg" class="user-image" alt="User Image"/>';
                        }else{
                         echo  yii\bootstrap\Html::img('/'.Yii::$app->user->identity->img,['class'=>'img-circle','alt'=>'User Image','height'=>20]);
//                            echo  \yii\helpers\Html::img('/'.Yii::$app->user->identity->img,['class'=>'img-circle','alt'=>'User Image','height'=>20]);
                        }?>
                        <?php if (Yii::$app->user->isGuest){
