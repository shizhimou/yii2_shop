...
<head>
    ...
    <link rel="stylesheet" href="/modules/style/list.css" type="text/css">
    ...
    <script type="text/javascript" src="/modules/js/list.js"></script>
</head>
<body>
<!-- 顶部导航 start -->
<?php
        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="/modules/images/list_hot1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/modules/images/list_hot2.jpg" alt="" /></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><img src="/modules/images/list_hot3.jpg" alt="" /></a></dt>
...
<!--                        <dt><a href=""><img src="/modules/images/goods1.jpg" alt="" /></a></dt>-->
                        <dt><a href="<?=\yii\helpers\Url::to(['list/goods','id'=>$good->id])?>"><?=\yii\helpers\Html::img($good->logo,['height'=>30])?> </a></dt>
